...
/**
 * An implementation of the DAML LedgerBackend API v1 with Sawtooth as the
 * backend.
 * @author scealiontach
 */
public final class SawtoothDamlLedgerBackend implements LedgerBackend {
  ...
  @Override
  public Source<LedgerSyncEvent, NotUsed> ledgerSyncEvents(final Option<String> offset) {
    // TODO Auto-generated method stub
    return null;
  }
