 ...
 */
public class SawtoothWriteException extends DamlSawtoothException {
   ...
   */
  public SawtoothWriteException(final Throwable throwable) {
    super(throwable);
  }
   ...
   * @param throwable exception.
   */
  public SawtoothWriteException(final  String message, final Throwable throwable) {
   ...
   */
  public SawtoothWriteException(final String message) {
    super(message);
  }
