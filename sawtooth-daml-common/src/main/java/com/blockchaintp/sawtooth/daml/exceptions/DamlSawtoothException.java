 ...
 */
public class DamlSawtoothException extends RuntimeException {
   ...
   */
  public DamlSawtoothException(final Throwable throwable) {
    super(throwable);
  }
   ...
   * @param throwable exception.
   */
  public DamlSawtoothException(final  String message, final Throwable throwable) {
   ...
   */
  public DamlSawtoothException(final String message) {
    super(message);
  }
